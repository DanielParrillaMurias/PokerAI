...
const deckX = () => {
  // Crea un array con los números del 1 al 52
  // const numbers = Array.from({length: 52}, (value, index) => index + 1); //
  const numbers = Array.from({length: 52}, (value, index) => index);

  // Baraja el array de números utilizando la función nativa de JavaScript Array.prototype.sort
